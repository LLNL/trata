...
def test_setContinuousVariable_valid():
    ...
    assert expected_variable1==actual_variable1
...
def test_getPoints_invalid():
    ...
    pytest.raises(KeyError, test_samples.get_points, 'invalidVar')
    # Variable does not exist in testSamples (list argument len 1)
    pytest.raises(KeyError, test_samples.get_points, ['invalidVar'])
    # Variable does not exist in testSamples (list argument len 2)
    pytest.raises(KeyError, test_samples.get_points, ['invalidVar1', 'invalidVar2'])
    # Variable does not exist in testSamples (list argument 1 invalid 1 valid)
    pytest.raises(KeyError, test_samples.get_points, ['invalidVar', ls_variables[0]])
    # Invalid type
...
def test_getLength_invalid():
    ...
    test_samples.generate_samples(ls_variables, test_sampler, num_points=i_num_points, seed=i_seed)
    # Variable does not exist in testSamples (string argument)
    pytest.raises(KeyError, test_samples.get_length, 'invalidVar')
    # Variable does not exist in testSamples (list argument len 1)
    pytest.raises(KeyError, test_samples.get_length, ['invalidVar'])
    # Variable does not exist in testSamples (list argument len 2)
    pytest.raises(KeyError, test_samples.get_length, ['invalidVar1', 'invalidVar2'])
    # Variable does not exist in testSamples (list argument 1 invalid 1 valid)
    pytest.raises(KeyError, test_samples.get_length, ['invalidVar', ls_variables[0]])
    # Invalid type
...
def test_getRange_invalid():
    ...
    test_samples.generate_samples(ls_variables, test_sampler, num_points=i_num_points, seed=i_seed)
    # Variable does not exist in testSamples (string argument)
    pytest.raises(KeyError, test_samples.get_ranges, 'invalidVar')
    # Variable does not exist in testSamples (list argument len 1)
    pytest.raises(KeyError, test_samples.get_ranges, ['invalidVar'])
    # Variable does not exist in testSamples (list argument len 2)
    pytest.raises(KeyError, test_samples.get_ranges, ['invalidVar1', 'invalidVar2'])
    # Variable does not exist in testSamples (list argument 1 invalid 1 valid)
    pytest.raises(KeyError, test_samples.get_ranges, ['invalidVar', ls_variables[0]])
    # Invalid type
...
def test_getVariable_invalid():
    ...
    test_samples.generate_samples(ls_variables, test_sampler, num_points=i_num_points, seed=i_seed)
    # Variable does not exist in testSamples (string argument)
    pytest.raises(KeyError, test_samples.get_variables, 'invalidVar')
    # Variable does not exist in testSamples (list argument len 1)
    pytest.raises(KeyError, test_samples.get_variables, ['invalidVar'])
    # Variable does not exist in testSamples (list argument len 2)
    pytest.raises(KeyError, test_samples.get_variables, ['invalidVar1', 'invalidVar2'])
    # Variable does not exist in testSamples (list argument 1 invalid 1 valid)
    pytest.raises(KeyError, test_samples.get_variables, ['invalidVar', ls_variables[0]])
    # Invalid type
    pytest.raises(TypeError, test_samples.get_variables, 123)
    # Invalid type in list
    pytest.raises(TypeError, test_samples.get_variables, [123])
