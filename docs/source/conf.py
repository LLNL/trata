...
sys.path.insert(0, os.path.abspath(__file__).rsplit(os.sep, 3)[0])
...
latex_documents = [
    ('index', 'trata.tex', 'Trata Documentation',
     author, 'manual'),
]
...
man_pages = [
    ('index', 'trata', 'Trata Documentation',
     author, 1)
]
...
texinfo_documents = [
    ('index', 'trata', 'Trata Documentation',
     author, 'trata', 'Sampling methods for UQ and sensitivity analyses.',
     'Miscellaneous'),
]
